...
const ERPUserManuals = () => (
  <div className="ks-bg">
    <div className="ks-container">
      <h1 className="ks-title" style={{ textAlign: 'center', marginBottom: '2rem' }}>ERP (User Manuals)</h1>
